...
class BonusProcessorTest {

    @ParameterizedTest
    @MethodSource
    void CT001(int faltas, double expectSalary) throws AppExceptions {
        // Arrange
    ...
    @ParameterizedTest
    @MethodSource
    void CT002(int distancia, double expectSalary) throws AppExceptions {
        // Arrange
        Employee employee = new Employee("Fulano", 2500.00, "Zelador");
    ...
    @ParameterizedTest
    @MethodSource
    void CT003(String occupation, double expectSalary) throws AppExceptions {
        // Arrange
