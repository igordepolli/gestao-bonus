...
public class JNumberFormatField extends JTextField {
    ...
    public JNumberFormatField(NumberFormat format) {// define o formato do
        ...
        setDocument(new PlainDocument() {
            ...
            public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
                ...
                super.insertString(0, numberFormat.format(new BigDecimal(limit).divide(new BigDecimal(String.valueOf(Math.pow(10, numberFormat.getMaximumFractionDigits()))))), a);
            }
    ...
    public final BigDecimal getValue() {
        return new BigDecimal(getText().replaceAll("[^0-9]", "")).divide(new BigDecimal(String.valueOf(Math.pow(10, numberFormat.getMaximumFractionDigits()))));
    }
